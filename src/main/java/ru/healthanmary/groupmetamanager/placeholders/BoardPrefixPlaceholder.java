...
public class BoardPrefixPlaceholder extends PlaceholderExpansion {
    @Override
    public @NotNull String getIdentifier() {
        return "groupmeta-board-prefix";
    }
    ...
    public @Nullable String onPlaceholderRequest(Player player, @NotNull String params) {
        ...
        String targetPermission = "boardprefix.";
        ...
        if (!nodes.isEmpty()) {
            for (PermissionNode permNode : nodes) {
                if (permNode.getKey().startsWith(targetPermission)) {
                    ...
                    return prefix.isEmpty() ? ChatColor.GRAY + " Отсутствует" : " " + prefix;
                }
            }
        } else {
            return ChatColor.GRAY + " Отсутствует";
        }
        return ChatColor.GRAY + " Отсутствует";
    }
}
